# 🌐 GDG AR/VR — Open Source Projects Repository
...
### 🏙️ 1. 3D Domain City Model Project
...
### 🎂 2. AR Birthday Card
An **Augmented Reality Birthday Greeting Card** built using **Unity + Vuforia**.
When a user scans a physical birthday card, interactive 3D birthday elements appear.
...
### 🎬 3. Taarangana’26 — 3D Announcement Reel
A **cinematic 3D vertical reel (9:16)** created for the college fest **Taarangana’26**.
Each contributor models one environment asset used in the final reel.
